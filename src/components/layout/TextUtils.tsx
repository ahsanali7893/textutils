  ...
  >
    ...
    <div className="max-w-screen-lg mx-auto px-5 sm:px-0 py-12">
      ...
      <div className="flex flex-wrap ">
        <button
          onClick={uppercase}
          className="text-white my-2 mx-2 sm:my-2 sm:mx-0 bg-fuchsia-600 border-0 py-2 px-6 focus:outline-none hover:bg-yellow-600 rounded text-sm duration-300"
        >
          UpperCase
        </button>
        <button
          onClick={lowercase}
          className="text-white my-2 mx-12 sm:mx-2 sm:my-2  bg-emerald-500 border-0 py-2 px-6 focus:outline-none hover:bg-yellow-600 rounded text-sm duration-300"
        >
          LowerCase
        </button>
        <button
